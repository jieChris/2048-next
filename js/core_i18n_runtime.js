(function (global) {
  ...
  var FIXED_SELECTOR_TEXT = [
    ...
    { s: "#pku2048-inline-stats-toggle + .settings-switch-slider .settings-inline-desc-sr", zh: "直接显示在页面中", en: "Show inline on page." },
  ...
  var FIXED_SELECTOR_ATTR = [
    ...
    { s: "#top-user-profile-btn", a: "title", zh: "用户中心", en: "User Center" },
    { s: "#top-user-profile-btn", a: "aria-label", zh: "用户中心", en: "User Center" },
  ...
  var PHRASES = [
    ...
    ["重开提示", "Restart Confirmation"], ["重开游戏前显示确认提示", "Ask before starting a new game"],
    ...
    ["步骤 ", "Step "], [" · ", " · "],
    ["选中 0 后，点击同一格会按 0→1→2→4→…→65536 循环。", "After selecting 0, clicking the same cell cycles 0→1→2→4→…→65536."],
    ["▲ 上移 ▼ 下移", "▲ Up ▼ Down"],
    ["▲ 上移", "▲ Up"],
    ["▼ 下移", "▼ Down"],
