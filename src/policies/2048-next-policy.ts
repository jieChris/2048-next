...
const PRIVACY_ZH: PolicyDocument = {
  ...
  shortTitle: "隐私政策",
  intro: "本政策说明 2048 NEXT 网页版与 Android App 在本地离线体验、账号联网功能、游戏记录、排行榜、成就和稳定性诊断中如何处理信息。当前文本尚未生效，正式版本必须补齐运营主体、联系邮箱和生效日期并经用户明确批准。",
  sections: [
    {
      title: "一、适用范围与基本原则",
      paragraphs: [
    ...
    },
    {
      ...
      items: [
        ...
        "服务器托管与本地回放存储：账号、游戏数据库和回放由 2048-game-api 的受控 PostgreSQL 与服务器私有存储处理；正式政策将在发布前补充最终生产托管地域和服务商信息。",
      ],
    },
    {
      title: "七、保存期限与删除",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "当前草案尚缺运营主体名称、正式联系邮箱和生效日期，因此不能作为已生效政策或公开发行候选文本。",
      ],
    },
  ],
};
...
const PRIVACY_EN: PolicyDocument = {
  ...
  intro: "This policy explains how the 2048 NEXT website and Android App handle information for offline play, account features, game records, leaderboards, achievements, and stability diagnostics. This draft is not effective. The operator identity, contact email, and effective date must be completed and explicitly approved before release.",
  sections: [
    {
    ...
    },
    {
      ...
      items: [
        ...
        "Server hosting and local replay storage: account and game databases and replays are processed by controlled PostgreSQL and private server storage used by 2048-game-api. The final policy will name the production hosting location and provider before release.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "This draft is missing the operator identity, formal contact email, and effective date and cannot serve as an effective policy or public release candidate.",
      ],
    },
  ],
};
...
const TERMS_ZH: PolicyDocument = {
  ...
  shortTitle: "用户协议",
  intro: "本协议适用于 2048 NEXT 网页版与 Android App。当前文本尚未生效，正式版本必须补齐运营主体、联系邮箱和生效日期并经用户明确批准。",
  sections: [
    {
      title: "一、服务内容",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "当前草案尚缺运营主体名称、正式联系邮箱和生效日期，因此不能作为已生效协议或公开发行候选文本。",
      ],
    },
  ],
};
...
const TERMS_EN: PolicyDocument = {
  ...
  intro: "These terms apply to the 2048 NEXT website and Android App. This draft is not effective. The operator identity, contact email, and effective date must be completed and explicitly approved before release.",
  sections: [
    {
      title: "1. Service",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "This draft is missing the operator identity, formal contact email, and effective date and cannot serve as effective terms or a public release candidate.",
      ],
    },
  ],
};
