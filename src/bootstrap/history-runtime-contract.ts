...
export interface HistoryRuntimeContractWindowLike {
  ...
  CoreHistoryControlsHostRuntime?: unknown;
...
export interface ResolveHistoryRuntimeContractsResult {
  ...
  historyControlsHostRuntime: AnyRecord;
...
export function resolveHistoryRuntimeContracts(
  ...
  const historyFilterHostRuntime = requireRuntimeFunctions(
  ...
  const historyLoadEntryHostRuntime = requireRuntimeFunctions(
