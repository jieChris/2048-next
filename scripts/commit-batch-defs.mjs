  ...
  4: {
    ...
    match: (file) =>
      [
        ...
        "tests/unit/architecture-budget-check.spec.ts",
        "tests/unit/architecture-budget-baseline-ref.spec.ts",
        "tests/unit/architecture-budget-baseline-selector.spec.ts",
        "tests/unit/architecture-budget-source-path.spec.ts",
        "tests/unit/architecture-budget-exception-boundary.spec.ts",
        "tests/unit/core-load-budget-check.spec.ts",
        "tests/unit/core-load-budget-baseline-ref.spec.ts",
        "tests/unit/core-load-budget-parser.spec.ts",
        "tests/unit/core-performance-budget.spec.ts",
        "tests/unit/core-performance-browser.spec.ts",
        "tests/unit/core-performance-lifecycle.spec.ts",
        "tests/unit/core-performance-runner.spec.ts",
        "tests/unit/core-performance-integration.spec.ts",
        ...
        "scripts/architecture-budget-check.mjs",
        "scripts/core-load-budget-check.mjs",
        "scripts/core-performance-check.mjs",
        "scripts/core-performance/policy.mjs",
        "scripts/core-performance/sample-schema.mjs",
        "scripts/process-tree.mjs",
        "config/core-performance-budgets.json",
        "config/core-performance-budget-exceptions.json",
        "config/core-load-budgets.json",
      ...
      /^scripts\/architecture-budget\/[^/]+\.mjs$/u.test(file) ||
      /^scripts\/core-load-budget\/[^/]+\.mjs$/u.test(file) ||
      /^scripts\/core-performance\/[^/]+\.mjs$/u.test(file) ||
