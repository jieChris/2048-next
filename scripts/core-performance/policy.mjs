...
const RELATIVE_RATCHET_THRESHOLD = "relative-ratchet";
const IMMUTABLE_ABSOLUTE_THRESHOLD = "immutable-absolute";
const RESOURCE_METRICS = ["requestCount", "transferBytes", "decodedBodyBytes"];

const FIXED_EXECUTION_POLICIES = {
  [GITHUB_ACTIONS_LINUX_X64_EXECUTION_PROFILE]: {
    timingAndInteractionThreshold: IMMUTABLE_ABSOLUTE_THRESHOLD,
    resourceThreshold: RELATIVE_RATCHET_THRESHOLD,
  },
};

const LEGACY_SCHEMA_V2_EXECUTION_BASELINE_METRICS = {
  [GITHUB_ACTIONS_LINUX_X64_EXECUTION_PROFILE]: {
